            ...
            checks.forEach((check) => {
                ...
                _data.read('checks', check, (err, originalCheckData) => {
                    if (!err && originalCheckData) {
                        ...
                        // let that function continue the function or
                        // log the error(s) as needed
...
// Perform the check, send the originalCheck data and
// the outcome of the check process to the next step in the process
workers.performCheck = (originalCheckData) => {
    // 
...
// Alert the user as to a change in their checks status
workers.alertUserToStatusChange = (newCheckData) => {
    ...
    helpers.sendTwilioSms(newCheckData.userPhone, msg, (err) => {
        if (!err) {
            debug('Success: User was alerted to status change in their check , via sms: ', msg);
        } else {
